...
public record ProductoVentaFilterDto(
        ...
        @Positive(message = "El idTipoProductoMs3 debe ser positivo.")
        Long idTipoProductoMs3,

        @Positive(message = "El idCategoriaMs3 debe ser positivo.")
        Long idCategoriaMs3,

        @Positive(message = "El idMarcaMs3 debe ser positivo.")
        Long idMarcaMs3,

        @Size(max = 60, message = "El estado de registro no debe superar 60 caracteres.")
        String estadoRegistro,

        @Size(max = 60, message = "El estado de publicación no debe superar 60 caracteres.")
        String estadoPublicacion,

        @Size(max = 60, message = "El estado de venta no debe superar 60 caracteres.")
        String estadoVenta,
